...
// GitHub-style emoji shortcodes → Unicode. Matched by name in markdownToHtml.
const EMOJI = {
  100: '💯', angry: '😠', arrow_down: '⬇️', arrow_left: '⬅️',
  arrow_right: '➡️', arrow_up: '⬆️', artists: '🎨', ask: '🙋',
  atom: '⚛️', baby: '👶', back: '🔙', ballot_box: '🗳️',
  banana: '🍌', basketball: '🏀', bat: '🦇', bath: '🛀',
  beach: '🏖️', bear: '🐻', beer: '🍺', beers: '🍻',
  bell: '🔔', birthday: '🎂', black_heart: '🖤', blush: '😊',
  boat: '⛵', bomb: '💣', book: '📖', bookmark: '🔖', books: '📚',
  boom: '💥', brain: '🧠', bread: '🍞', briefcase: '💼',
  broken_heart: '💔', bug: '🐛', building: '🏢', bulb: '💡',
  bus: '🚌', butterfly: '🦋', calendar: '📅', call: '📞',
  camera: '📷', candy: '🍬', car: '🚗', cat: '🐱',
  chair: '🪑', check: '✅', cheers: '🍻', chef: '👨‍🍳',
  church: '⛪', clap: '👏', clock: '⏰', cloud: '☁️',
  coffee: '☕', cold_sweat: '😰', compass: '🧭', computer: '💻',
  confetti: '🎊', construction: '🚧', cookie: '🍪', cool: '😎',
  copyright: '©️', corn: '🌽', couch: '🛋️', cowboy: '🤠',
  crab: '🦀', credit_card: '💳', cricket: '🦗', cross: '✝️',
  cry: '😢', crystal_ball: '🔮', dagger: '🗡️', dance: '💃',
  dark_sunglasses: '🕶️', dash: '💨', dec: '🔴', delivery: '📦',
  diamond: '💎', dog: '🐶', dove: '🕊️', dragon: '🐉',
  drum: '🥁', duck: '🦆', dust: '💨', ear: '👂',
  earth_africa: '🌍', earth_americas: '🌎', earth_asia: '🌏',
  egg: '🥚', electric_plug: '🔌', elephant: '🐘',
  envelope: '📧', eraser: '🧽', euro: '💶', exclamation: '❗',
  eye: '👀', facepunch: '👊', factory: '🏭', fall: '🍂',
  family: '👨‍👩‍👧‍👦', fax: '📠', feathers: '🪶', fedora: '🎩',
  fire: '🔥', firecracker: '🧨', firework: '🎆',
  first_place: '🥇', fist: '✊', flags: '🎏', flesh: '🫳',
  float: '🪂', floppy_disk: '💾', football: '🏈',
  footprints: '👣', fork_knife: '🍴', fort: '🏰', fox: '🦊',
  frog: '🐸', fu: '🖕', fuel: '⛽', full_moon: '🌕',
  game: '🎮', ghost: '👻', gift: '🎁', giraffe: '🦒',
  glass: '🥛', globe: '🌐', goal: '🥅', gorilla: '🦍',
  grapes: '🍇', green_apple: '🍏', green_heart: '💚',
  guitar: '🎸', hamburger: '🍔', hammer: '🔨',
  hammer_pick: '⚒️', hamster: '🐹', hand: '✋', handshake: '🤝',
  hatched_chick: '🐥', headphones: '🎧', heart: '❤️',
  heart_decoration: '💟', heart_eyes: '😍', heartbeat: '💓',
  hearts: '💘', heavy_check: '✅', heavy_minus: '➖',
  heavy_plus: '➕', hi: '👋', helmet_white: '⛑️',
  high_brightness: '🔆', honey: '🍯', horse: '🐴',
  hospital: '🏥', hourglass: '⏳',
  hourglass_flowing: '⏳', house: '🏠', house_garden: '🏡',
  ice: '🧊', ice_cream: '🍦', inbox_tray: '📥', inbox: '📧',
  information: 'ℹ️', jack_o_lantern: '🎃', joystick: '🕹️',
  key: '🔑', keyboard: '⌨️', kiwi: '🥝', knife: '🔪',
  knot: '🪢', label: '🏷️', lab_coat: '🥼', lantern: '🏮',
  laptop: '💻', large_blue_diamond: '🔷', last_place: '🥉',
  laugh: '😄', leaves: '🌿', ledger: '📒', lemon: '🍋',
  leo: '♌', library: '📚', life_ring: '🛟',
  light_rail: '🚈', link: '🔗', lion: '🦁', lips: '👄',
  lipstick: '💄', lizard: '🦎', lock: '🔒', lollipop: '🍭',
  loupe: '🔍', love: '😍', love_you_gesture: '🤟',
  luggage: '🧳', magic: '🎩', magnet: '🧲', male: '♂️',
  man: '👨', man_dancing: '🕺', mango: '🥭', map: '🗺️',
  mask: '😷', massage: '💆', meat: '🥩', medal: '🏅',
  mega: '📣', melon: '🍉', memo: '📝', menorah: '🕎',
  metal: '🤘', metro: '🚇', mic: '🎤', microphone: '🎤',
  microscope: '🔬', milk: '🥛', milky_way: '🌌',
  minibus: '🚐', moai: '🗿', money_with_wings: '💸',
  moneybag: '💰', money_mouth: '🤑', monkey: '🐒',
  moon: '🌔', mountain: '⛰️', mouse: '🐁', movie: '🎬',
  mushroom: '🍄', nail_care: '💅', necktie: '👔',
  nerd: '🤓', nervous: '😰', new_moon: '🌑', no_entry: '⛔',
  notes: '🎶', nuclear: '☢️', ocean: '🌊', octopus: '🐙',
  oncoming_bus: '🚍', oncoming_automobile: '🚘',
  oncoming_police_car: '🚔', oncoming_taxi: '🚖',
  open_file_folder: '📂', open_hands: '👐', open_mouth: '😮',
  options: '⚙️', orange: '🍊', owl: '🦉', ox: '🐂',
  package: '📦', pager: '📟', palm_tree: '🌴', panda: '🐼',
  paperclip: '📎', parking: '🅿️', parrot: '🦜',
  part_alternation: '🎵', passport: '📋', pasta: '🍝',
  pause_button: '⏸️', peace: '☮️', peach: '🍑', pear: '🍐',
  pencil: '✏️', penguin: '🐧', phone: '📞', phone_telephone: '☎️',
  photo: '📷', picture_frame: '🖼️', pie: '🥧', pig: '🐷',
  pig_nose: '🐽', pig2: '🐗', pill: '💊', ping_pong: '🏓',
  pizza: '🍕', place_of_worship: '🛐', point_down: '👇',
  point_left: '👈', point_right: '👉', point_up: '☝️',
  point_up_2: '👆', police: '👮', poop: '💩', postbox: '📫',
  potable_water: '🚰', potato: '🥔', pouch: '👝',
  poultry_leg: '🍗', pound: '💷', prayer: '🙏',
  prawn: '🦐', prince: '🤴', princess: '👸',
  purple_heart: '💜', purse: '👛', pushpin: '📌',
  put_litter: '🚮', rabbit: '🐰', racehorse: '🐎',
  radio: '📻', rainbow: '🌈', raised_hands: '🙌',
  raised_hand: '✋', ramen: '🍜', rat: '🐀',
  rage: '😠', recycling: '♻️', red_circle: '🔴', registered: '®️',
  relaxed: '☺️', restroom: '🚻', ribbon: '🎀',
  ring: '💍', rocket: '🚀', rooster: '🐓', rose: '🌹',
  rotate: '🔄', round_pushpin: '📍', rugby: '🏉',
  running: '🏃', runner: '🏃', sailboat: '⛵', salad: '🥗',
  sandal: '👡', santa: '🎅', satellite: '📡',
  satisfied: '😌', sauce: '🥫', sauna: '🧖',
  scales: '⚖️', school: '🏫', school_satchel: '🎒',
  scorpion: '🦂', scream: '😱', scroll: '📜', seafood: '🍤',
  secrets: '🤫', seedling: '🌱', shaker: '🧂', shark: '🦈',
  sheep: '🐑', shell: '🐚', ship: '🚢', shipping: '📦',
  shoe: '👟', shower: '🚿', shrimp: '🦐', shrug: '🤷',
  signal: '📶', skeleton: '💀', ski: '🎿', skull: '💀',
  sleeping: '😴', sleeping_accommodation: '🛌', sleepy: '💤',
  slider: '🎚️', slot_machine: '🎰', small_airplane: '🛩️',
  small_blue_diamond: '🔹', small_orange_diamond: '🔸',
  small_red_triangle: '🔺', smile: '😄', smirk: '😏',
  smoke: '💨', snail: '🐌', snake: '🐍', snorkel: '🤿',
  snowflake: '❄️', snowman: '⛄', sos: '🆘', soccer: '⚽',
  socks: '🧦', soup: '🍲', space_invader: '👾',
  spades: '♠️', spaghetti: '🍜', sparkles: '✨',
  speaker: '🔊', speech_balloon: '💬', speedboat: '🚤',
  star: '⭐', star2: '🌟', stars: '🌠', station: '🚉',
  steam_locomotive: '🚂', steering_wheel: '🛵',
  strawberry: '🍓', strings: '🎻', strong: '💪',
  sun: '☀️', sunny: '☀️', sunrise: '🌅',
  sunrise_over_mountains: '🌄', superhero: '🦸',
  superheroine: '🦸‍♀️', surfer: '🏄', sushi: '🍣',
  swan: '🦢', swirl: '🌀', sword: '⚔️', syringe: '💉',
  tablet: '📱', taco: '🌮', tada: '🎉', tape: '📎',
  taxi: '🚕', tea: '🍵', telephone_receiver: '📞',
  telescope: '🔭', tennis: '🎾', thinking: '🤔',
  ticket: '🎫', tiger: '🐯', tiger2: '🐅', timer: '⏱️',
  tired: '😫', toilet: '🚽', tokyo_tower: '🗼',
  tomato: '🍅', tongue: '👅', top: '🔝', tophat: '🎩',
  tornado: '🌪️', track_next: '⏭️', track_prev: '⏮️',
  tractor: '🚜', traffic_light: '🚥', train: '🚌',
  train2: '🚆', triumph: '🎉', trophy: '🏆',
  tropical_fish: '🐠', tshirt: '👕', tsunami: '🌊',
  turtle: '🐢', tv: '📺',
  twisted_rightwards_arrows: '🔀', two_hearts: '💕',
  umbrella: '☔', unamused: '😒',
  up: '⬆️', v: '✌️', victory: '✌️',
  video_camera: '📹', violin: '🎻', volcano: '🌋',
  vs: '🆚', vulcan: '🖖', waffle: '🧇', warm: '😊',
  warning: '⚠️', waterfall: '🏞️', wave: '👋',
  waxing_crescent: '🌒', wc: '🚾', wealth: '💰',
  wedding: '💒', whale: '🐳', wheelchair: '♿',
  white_check: '✅', white_circle: '⚪', white_flower: '💮',
  wind_blowing_face: '🌬️', wine_glass: '🍷', wink: '😉',
  wolf: '🐺', women: '👩', women_facepalming: '🤦‍♀️',
  women_with_bunny_ears: '👯‍♀️',
  women_with_raised_hands: '🙋‍♀️', wrench: '🔧',
  writing: '✍️', x: '❌', yum: '😋', zap: '⚡',
  zzz: '💤',
  // Deck-specific
  alarm_clock: '⏰', kissing_heart: '😘',
};
...
function markdownToHtml(md) {
  ...
  // Emoji shortcodes — replace known GitHub-style :name: with Unicode.
  // After code/math protection so :emoji: inside `code` is left untouched.
  html = html.replace(/:([a-z0-9_]+):/g, (m, name) => EMOJI[name] || m);
